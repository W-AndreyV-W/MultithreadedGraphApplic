...
#include "../MultithreadedGraphApplic/workerthread.h"
...
QT_MOC_LITERAL(1, 13, 10), // "sig_worket"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 12), // "numberThread"
QT_MOC_LITERAL(4, 38, 4) // "iter"

    },
    "WorkerThread\0sig_worket\0\0numberThread\0"
    "iter"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_worket((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (WorkerThread::*_t)(unsigned int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::sig_worket)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::sig_worket(unsigned int _t1, int _t2)
{
